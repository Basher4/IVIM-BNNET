"""
Train BNN on real AND synthetic data.
"""
...
model_path = "./sw/models/bnn_e18.pt"
info_path = "./sw/models/bnn_e18.json"
BAYES_SAMPLES = 256
...
# Train network
X_train = np.concatenate(datatot, train_signals_5[0], train_signals_50[0])
